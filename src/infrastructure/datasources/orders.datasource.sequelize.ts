...
export class OrdersDataSource implements IOrdersDataSource {
    ...
    async createOrder(createOrderDto: CreateOrderDto): Promise<Partial<OrdersEntity>> {

        const { negocio_id, status, user_id, cartItems } = createOrderDto;
    ...
    async updateOrder(orderId: number, data: Partial<OrdersEntity>): Promise<OrdersEntity> {
